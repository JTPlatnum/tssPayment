...
function addNewRow() {
	...
	html += '<div class="div"><label>Shoe Brand</label><select id="id_select_brand_' + newtr_id + '" name="brand_' + newtr_id + '" class="test_brand_' + newtr_id + '" style="text-transform: none;float: left;border: 1px solid #ddd;width: 156px;padding: 2px 0px;border-radius:2px 2px 2px 2px;   box-shadow: 0 1px 1px rgba(0, 0, 0, 0.075) inset;" tabindex="3"><option value="0">Please Select </option><?php while($data=mysql_fetch_assoc($brandjs)){?><option value="<?=$data['id']?>"><?=$data['name']?> </option><?php } ?></select> </div>';
    ...
    <li  class="responsive" id="image-row_0">
      <div class="div">
        <label>Shoe Brand</label>
         <select class="id_select_brand_0"  id="id_select_brand_0" name="brand_0" style="text-transform: none;float: left;border: 1px solid #ddd;width: 154px;padding: 2px 0px;border-radius:2px 2px 2px 2px;   box-shadow: 0 1px 1px rgba(0, 0, 0, 0.075) inset;" tabindex="3">
     ...
     <?php while($data=mysql_fetch_assoc($brand)){?>
      ...
      <div class="div">
        <label>Size</label>
         <select  class="id_select" id="id_select" name="size_0" style="text-transform: none;float: left;border: 1px solid #ddd;width: 156px;padding: 2px 0px;border-radius: 2px 2px 2px 2px;   box-shadow: 0 1px 1px rgba(0, 0, 0, 0.075) inset;" tabindex="2">
           <option value="0">Please Select </option>
