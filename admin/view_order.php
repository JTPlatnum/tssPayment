...
<div align="center">
      ...
      <div class="viewform">
        <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
         <table width="100%" cellspacing="0" cellpadding="0"  class="maintbl" >
          ...
          <textarea name="description" id="description" style="float: left; margin: 14px;" cols="45" rows="7"><?php echo $dec['description']; ?></textarea><br>
  ...
  <tbody>
    <tr>
      ...
      <td><?php echo "$"; echo $amsilver;
	   number_format($amsilver, 2);
	  ?></td>
    </tr>
    <tr>
      <td><?php echo $num2; echo " ";?>pairs Gold Service</td>
      <td><?php echo "$"; echo $amgold;
	  
	  number_format($amgold, 2);
	  ?></td>
    </tr>
    <tr>
      <td>Tax</td>
    ...
    <tr>
      <td>Pair Total</td>
      <td><?php echo "$";  $total=$amsilver+$amgold+$tax;
