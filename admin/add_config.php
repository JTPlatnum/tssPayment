...
$tabl = 'tax';						     // for database table name that used on this page
$item = 'tax';
            ...
            <tr>                
              <td align="right" class="label_form">Gold : </td>
                ...
                <tr>                
                  ...
                  <td><input type="text" name="tax" class="input_text" value="<?php echo $dvar['tax']; ?>" onkeypress="return isNumberKey(event)"/> 
				  <br class="clear" /></td>
              </tr>
           <tr>
            <td>&nbsp;</td>
